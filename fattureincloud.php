...
class fattureincloud extends Module
{
    ...
    public function uninstall()
    {
        if (!parent::uninstall() || !$this->uninstallTab() ||
            ...
            !Configuration::updateValue('FATTUREINCLOUD_INVOICES_DELAY', 0) ||
    ...
    protected function getConfigForm()
    {
        ...
        $form_fields[] = array(
            'type' => 'switch',
            'label' => 'Crea fatture manualmente',
            'name' => 'FATTUREINCLOUD_INVOICES_DELAY',
            'is_bool' => true,
            'desc' => 'Se abilitato la fattura non verrà creata automaticamente, ma dovrà essere creata manualmente nella pagina ordine',
            'values' => array(
                array(
                    'id' => 'active_on',
                    'value' => true,
    ...
    protected function getConfigFormValues()
    {
        return array(
            ...
            'FATTUREINCLOUD_INVOICES_DELAY' => Configuration::get('FATTUREINCLOUD_INVOICES_DELAY'),
    ...
    public function hookActionOrderStatusPostUpdate($order)
    {
        ...
        if (Configuration::get('FATTUREINCLOUD_INVOICES_CREATE')
            && !Configuration::get('FATTUREINCLOUD_INVOICES_DELAY')
    ...
    public function hookDisplayAdminOrderSide($params)
    {
        ...
        } else if(Configuration::get('FATTUREINCLOUD_INVOICES_CREATE') && Configuration::get('FATTUREINCLOUD_INVOICES_DELAY')) {
            $this->context->smarty->assign([
                'create_invoice' => $this->context->link->getAdminLink('AdminFattureincloud', true, [], [
                    'action' => 'createInvoice',
                    'id_order' => $params['id_order'],
                ])
            ]);

            return $this->display(__FILE__, 'invoice_create.tpl');
        }
